...
import { JournalEntryToolbarPresenter } from '../JournalEntryToolbarPresenter'

const ENTRY_COUNT = 3

function renderToolbar(
  overrides: Partial<Parameters<typeof JournalEntryToolbarPresenter>[0]> = {}
) {
  const props = {
  ...
  return {
    ...
    ...render(
      <I18nextProvider i18n={i18n}>
        <JournalEntryToolbarPresenter {...props} />
      </I18nextProvider>
    )
  }
}

describe('JournalEntryToolbarPresenter', () => {
